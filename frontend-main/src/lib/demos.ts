...
export const DEMO_NICHES: DemoNiche[] = [
  {
    ...
    subdomain: 'demo-yoga',
    name: 'Yoga Studio',
    tagline: 'Forest-themed yoga school selling courses + live drop-in classes.',
  ...
  },
  {
    ...
    tagline: 'High-intensity training plans, calendars, and Zoom group classes.',
  ...
  },
  {
    ...
    tagline: 'Progressive skill courses with subscription tiers and recordings.',
  ...
  },
  {
    ...
    tagline: 'Niche micro-courses with email campaigns and downloadable guides.',
  ...
  },
  {
    ...
    name: 'Makeup Academy',
    tagline: 'Tutorial libraries, on-site workshops, and creator merch bundles.',
