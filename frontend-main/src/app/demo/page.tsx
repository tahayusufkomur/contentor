...
import { ArrowRight, GraduationCap, LayoutDashboard, Sparkles } from 'lucide-react'
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-16 sm:py-24">
        <header className="mb-12 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            Each demo is a fully wired tenant with real courses, schedules, and admin tools.
            Click in as a student to see what your customers experience — or as a coach to
            explore the dashboard you&apos;ll work in.
          </p>
        </header>
        ...
        <section className="mt-16 rounded-2xl border border-border bg-muted/30 p-8 text-center">
          ...
          <p className="mx-auto mb-6 max-w-xl text-muted-foreground">
            Spin up your own copy in 30 seconds — keep the design, drop the demo content,
            and start adding your courses.
          </p>
          <Link
            href="/signup"
