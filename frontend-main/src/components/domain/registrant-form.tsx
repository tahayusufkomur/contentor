  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <p className="text-xs text-muted-foreground">
        Domain registrars require the owner&apos;s contact details to register a domain. We only use them for the
        registration.
      </p>
      ...
      <div className={field}>
        ...
        <Input id="addr" value={address1} onChange={(e) => setAddress1(e.target.value)} />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className={field}>
          ...
          <select id="country" value={country} onChange={(e) => onCountryChange(e.target.value)} className={SELECT_CLASS}>
            {COUNTRIES.map((c) => (
