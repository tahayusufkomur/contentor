...
export function IosAddStep({
  ...
  return (
    <PhoneFrame className={className}>
      ...
      />
      <path
        d="M30.5 148 v5 M28 150.5 h5"
        stroke="var(--primary)"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <text x="41" y="153" fontSize="6" fontWeight="600" fill="var(--primary)">
        {label}
      </text>
      <rect
        x="29"
...
export function IosConfirmStep({
  label,
  className,
}: {
  label: string;
...
export function AndroidInstallStep({
  ...
  return (
    <PhoneFrame className={className}>
      ...
      <text x="75" y="93.5" fontSize="6" fontWeight="600" fill="var(--primary)">
        {label}
      </text>
      <rect
        x="64"
...
export function AndroidConfirmStep({
  label,
  className,
}: {
  label: string;
