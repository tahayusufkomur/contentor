...
export function matchesFacets(
  ...
  for (const [groupId, optIds] of Object.entries(selected)) {
    ...
    const ok = (item.filter_options ?? []).some(
      (o) => o.group === gid && optIds.includes(o.id),
    );
    if (!ok) return false;
  }
  return true;
