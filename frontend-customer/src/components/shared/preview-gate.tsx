  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold tracking-tight">{brandName || "Coming soon"}</h1>
        ...
        <a href="/login" className="inline-block text-xs text-muted-foreground underline-offset-4 hover:underline">
