...
const ocean: ThemePalette = {
  ...
  light: {
    ...
    border: "oklch(0.655 0.01 240)",
    input: "oklch(0.655 0.01 240)",
...
const ember: ThemePalette = {
  ...
  light: {
    ...
    border: "oklch(0.655 0.01 60)",
    input: "oklch(0.655 0.01 60)",
  ...
  dark: {
    ...
    "muted-foreground": "oklch(0.7 0.01 50)",
    accent: "oklch(0.515 0.11 70)",
    "accent-foreground": "oklch(0.93 0.008 60)",
    destructive: "oklch(0.396 0.141 25.723)",
    "destructive-foreground": "oklch(0.93 0.008 60)",
    border: "oklch(0.505 0.012 40)",
    input: "oklch(0.505 0.012 40)",
...
const forest: ThemePalette = {
  ...
  light: {
    ...
    border: "oklch(0.655 0.01 145)",
    input: "oklch(0.655 0.01 145)",
  ...
  dark: {
    ...
    "muted-foreground": "oklch(0.7 0.01 150)",
    accent: "oklch(0.51 0.08 80)",
    "accent-foreground": "oklch(0.93 0.008 145)",
    destructive: "oklch(0.396 0.141 25.723)",
    "destructive-foreground": "oklch(0.93 0.008 145)",
    border: "oklch(0.505 0.015 150)",
    input: "oklch(0.505 0.015 150)",
...
const sunset: ThemePalette = {
  ...
  light: {
    ...
    border: "oklch(0.655 0.01 20)",
    input: "oklch(0.655 0.01 20)",
  ...
  dark: {
    ...
    "muted-foreground": "oklch(0.7 0.01 15)",
    accent: "oklch(0.515 0.1 55)",
    "accent-foreground": "oklch(0.93 0.008 20)",
    destructive: "oklch(0.396 0.141 25.723)",
    "destructive-foreground": "oklch(0.93 0.008 20)",
    border: "oklch(0.505 0.012 15)",
    input: "oklch(0.505 0.012 15)",
...
const violet: ThemePalette = {
  ...
  dark: {
    ...
    accent: "oklch(0.53 0.14 340)",
    "accent-foreground": "oklch(0.93 0.008 300)",
    destructive: "oklch(0.396 0.141 25.723)",
    "destructive-foreground": "oklch(0.93 0.008 300)",
    border: "oklch(0.505 0.015 290)",
    input: "oklch(0.505 0.015 290)",
...
const slate: ThemePalette = {
  ...
  light: {
    ...
    border: "oklch(0.655 0.006 250)",
    input: "oklch(0.655 0.006 250)",
