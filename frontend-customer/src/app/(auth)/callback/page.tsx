...
export default function CallbackPage() {
  ...
  if (error) {
    return <div className="flex min-h-screen items-center justify-center"><p className="text-destructive">{error}</p></div>
  }
  return <div className="flex min-h-screen items-center justify-center"><p>Verifying...</p></div>
}
