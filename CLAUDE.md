...
This project is indexed by GitNexus as **contentor** (18708 symbols, 34469 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
