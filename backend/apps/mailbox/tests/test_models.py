...
def test_message_links_to_conversation(tenant_ctx):
    ...
    conv = Conversation.objects.create(counterparty_email="stu@x.com", counterparty_name="Stu", student=student)
...
def test_conversation_ordering_newest_first(tenant_ctx):
    ...
    new = Conversation.objects.create(counterparty_email="b@x.com", last_message_at=timezone.now())
