...
def test_inbound_unknown_domain_drops_with_200(tenant_ctx):
    resp = _post({"from": "p@x.com", "to": "info@nope.com", "subject": "Hi", "text": "yo", "message_id": "<u@x.com>"})
...
def test_inbound_stores_for_live_enabled_domain(tenant_ctx):
    ...
    resp = _post(
        {"from": "p@x.com", "to": "info@coach.com", "subject": "Hi", "text": "hello", "message_id": "<m@x.com>"}
    )
    assert resp.status_code == 200
...
def test_inbound_duplicate_message_id_is_200_no_store(tenant_ctx):
    ...
    body = {"from": "p@x.com", "to": "info@coach.com", "subject": "Hi", "text": "hello", "message_id": "<dup@x.com>"}
